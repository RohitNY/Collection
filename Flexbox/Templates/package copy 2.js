...
function GetMerchant(merchants) {
  ...
  const properties = Object.keys(merchantDetails).filter(prop => regx.test(prop));

  return new Merchant(
    merchantDetails.merchant.Value,
   // merchantDetails.merchant_list_price?.Value, 
    getLowestPrice(properties.map(prop => merchantDetails[prop] && merchantDetails[prop].Value)),
                  ...
                  "product": {
                    ...
                    "Fragments": {
                        ...
                        "GroupDocs": [
                          {
                            "Fragments": {
                              ...
                              "product_root_url": {
                                "Value": "https://www.amazon.com/Farnam-Triple-Action-Moisturizer-Conditioner/dp/B000HHSFTE"
                              }
                            }
                          }
                        ]
                      ...
                      "affiliate_product.name": {
                        "Value": "Farnam Rain Maker Triple Action Hoof Moisturizer and Conditioner"
                      },
                      ...
                      "affiliate_product.image_url": {
                        "Value": "https://images.wideopenpets.com/wp-content/uploads/2022/04/rainmaker.jpg"
                      }
                    }
                  },
                  "product_url": {
                ...
                "Fragments": {
                  "product": {
                    ...
                    "Fragments": {
                        ...
                        "GroupDocs": [
                          {
                            "Fragments": {
                              ...
                              "product_root_url": {
                                "Value": "https://www.amazon.com/Kaytee-Forti-Diet-Health-Bird-Parakeets/dp/B013GLHV1K"
                              }
                            }
                          }
                        ]
                      ...
                      "affiliate_product.image_url": {
                        "Value": "https://images.wideopenpets.com/wp-content/uploads/2022/04/kayteefortidiet.jpg"
                      }
                    }
                  },
                  "template": {
                ...
                "Fragments": {
                  "product": {
                    ...
                    "Fragments": {
                        ...
                        "GroupDocs": [
                          {
                            "Fragments": {
                              ...
                              "product_root_url": {
                                "Value": "https://www.amazon.com/Kaytee-Treat-Stick-Honey-Flavor/dp/B007QHBI60"
                              }
                            }
                          }
                        ]
                      ...
                      "affiliate_product.image_url": {
                        "Value": "https://images.wideopenpets.com/wp-content/uploads/2022/04/kayteetreatstick.jpg"
                      },
                      "affiliate_product.description": {
                        "Blocks": [
                          {
